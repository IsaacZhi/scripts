...
# this script configures a EC2 to work with following:
# run as default user with . isaac_config.sh 
# Modify from configure_image.sh  http://pastebin.com/download.php?i=WTXF7g7F
...
# mysql root:forsaasversion

# install some basic programs
sudo aptitude install -y build-essential

sudo aptitude install -y zip unzip ncompress

#sudo apt-get install -y sqlite3 libsqlite3-dev libssl-dev openssl zlib1g zlib1g-dev zlibc
sudo aptitude install -y sqlite3 sqlite3-doc libsqlite3-dev libssl-dev openssl zlib1g zlib1g-dev zlibc
sudo aptitude install -y libxslt-dev libxml2-dev
# libxslt1-dev
# sudo apt-get install -y git
# maybe can install git-all
sudo aptitude install git
# The git suggest: git-arch git-cvs git-daemon-run|git-daemon-sysvinit
sudo aptitude install git-arch git-cvs git-daemon-run git-doc git-el git-email git-gui git-svn gitk gitweb
# suggest by git-gui
sudo aptitude install aspell

#sudo apt-get install -y default-jre
# have two depends default-jre-headless  openjdk-6-jre
...
# no install the texinfo suggests
...
#in aptitude ruby1.9.1 suggests 4:  graphviz  ri1.9.1   ruby1.9.1-dev  ruby1.9.1-examples
sudo aptitude install graphviz ri1.9.1 ruby1.9.1-dev ruby1.9.1-examples
#in aptitude graphviz suggests 2:
sudo aptitude install graphviz-doc gsfonts
...
##rm -rf ruby-1.9.3-p194/ ruby-1.9.3-p194.tar.gz
...
##rm -rf rubygems-1.8.24/ rubygems-1.8.24.tgz
...
sudo aptitude install -y sphinxsearch
sudo aptitude install -y postgresql-server-dev-all
